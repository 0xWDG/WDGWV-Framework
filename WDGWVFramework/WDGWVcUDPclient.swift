...
@_silgen_name("WDGWVcUDPsocket_server") func c_WDGWVcUDPsocket_server(_ host:UnsafePointer<Int8>,port:Int32) -> Int32
@_silgen_name("WDGWVcUDPsocket_recive") func c_WDGWVcUDPsocket_recive(_ fd:Int32,buff:UnsafePointer<Byte>,len:Int32,ip:UnsafePointer<Int8>,port:UnsafePointer<Int32>) -> Int32
@_silgen_name("WDGWVcUDPsocket_close") func c_WDGWVcUDPsocket_close(_ fd:Int32) -> Int32
@_silgen_name("WDGWVcUDPsocket_client") func c_WDGWVcUDPsocket_client() -> Int32
@_silgen_name("WDGWVcUDPsocket_get_server_ip") func c_WDGWVcUDPsocket_get_server_ip(_ host:UnsafePointer<Int8>,ip:UnsafePointer<Int8>) -> Int32
@_silgen_name("WDGWVcUDPsocket_sentto") func c_WDGWVcUDPsocket_sentto(_ fd:Int32,buff:UnsafePointer<Byte>,len:Int32,ip:UnsafePointer<Int8>,port:Int32) -> Int32
...
open class UDPClient: Socket {
    public override init(address: String, port: Int32) {
        ...
        let ret = c_WDGWVcUDPsocket_get_server_ip(address, ip: remoteipbuff)
        ...
        let fd: Int32 = c_WDGWVcUDPsocket_client()
        if fd > 0 {
            self.fd = fd
        }
    }
    ...
    open func send(data: [Byte]) -> Result {
        ...
        let sendsize: Int32 = c_WDGWVcUDPsocket_sentto(fd, buff: data, len: Int32(data.count), ip: self.address, port: Int32(self.port))
    ...
    open func send(string: String) -> Result {
        ...
        let sendsize = c_WDGWVcUDPsocket_sentto(fd, buff: string, len: Int32(strlen(string)), ip: address, port: port)
    ...
    open func send(data: Data) -> Result {
        ...
        let sendsize = c_WDGWVcUDPsocket_sentto(fd, buff: buff, len: Int32(data.count), ip: address, port: port)
    ...
    open func recv(_ expectlen: Int) -> ([Byte]?, String, Int) {
        ...
        let readLen: Int32 = c_WDGWVcUDPsocket_recive(fd, buff: buff, len: Int32(expectlen), ip: &remoteipbuff, port: &remoteport)
...
open class UDPServer: Socket {
    ...
    public override init(address: String, port: Int32) {
        ...
        let fd = c_WDGWVcUDPsocket_server(address, port: port)
        if fd > 0 {
            self.fd = fd
        }
    }
