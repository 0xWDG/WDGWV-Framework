...
public extension String {
    ...
    func isEmpty() -> Bool {
        let nonWhitespaceSet = NSCharacterSet.whitespaceAndNewlineCharacterSet()
    ...
    func slugify() -> String {
        let slugCharacterSet = NSCharacterSet.init(charactersInString: "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-")
        return latinize().lowercaseString
    ...
    public func smile() -> String {
        return String(self).smilie()
    }
    
    public func smilie() -> String {
    ...
    public func replaceLC(target: String, withString: String) -> String {
        return (self.lowercaseString).stringByReplacingOccurrencesOfString(target, withString: withString, options: NSStringCompareOptions.LiteralSearch, range: nil)
    }
    
    public func load() -> String {
        return WDGWVFrameworkWeb().getDataAsText(self) as String;
    }
